...
represent sets, and a few function implementations that ar ebased on
this decision---for the functions that we've already seen in class.

Second, we've marked places in this file where you are you are to fill
...
--pair elt takes an element on h and a list b and returns a list of all
--pairs, (h,e), where e is an element of b
